...
import kourtis.quadrum.philosophito.databinding.FragmentSexualHarassmentBinding;
import kourtis.quadrum.philosophito.ui.main.data.FavoriteItem;
import kourtis.quadrum.philosophito.ui.main.data.datanames;

public class SexualHarassmentFragment extends Fragment {
    ...
    private FragmentSexualHarassmentBinding binding;
    ...
    private void saveItem() {
        ...
        favoriteItem.setId(datanames.SEX.toString());
        favoriteItem.setTextcontent("");
        favoriteItem.setTitle("Sexual Harassment");
        favoriteItem.setMdFile("file:///android_asset/harassment.md");
    ...
    private void removeItem() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(requireContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(datanames.SEX.toString());
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(datanames.SEX.toString())) {
            bookMark();
        } else {
            bookUnmark();
        }
    ...
    public View onCreateView(
        ...
        binding = FragmentSexualHarassmentBinding.inflate(inflater, container, false);
        View root = binding.getRoot();
        bookMark();
        MarkdownView markdownView = binding.content;
        markdownView.loadMarkdownFile("file:///android_asset/", "file:///android_asset/harassment.md", "file:///android_asset/style.css");
