...
public class WhistleBlowingFragment extends Fragment {
    ...
    private void saveItem() {
        ...
        favoriteItem.setId(datanames.WHISTLE.toString());
        favoriteItem.setTextcontent("");
        favoriteItem.setTitle("Whistle-Blowing");
        favoriteItem.setMdFile("file:///android_asset/whistleblowing.md");
    ...
    private void removeItem() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(requireContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(datanames.WHISTLE.toString());
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(datanames.WHISTLE.toString())) {
            bookMark();
        } else {
            bookUnmark();
        }
