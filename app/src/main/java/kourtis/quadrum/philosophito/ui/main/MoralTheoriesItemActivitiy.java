...
public class MoralTheoriesItemActivitiy extends AppCompatActivity {
    ...
    private void saveItem() {
        ...
        if (this.title.equals("Utilitarianism")) {
            ...
            this.mdfile = "file:///android_asset/util.md";
        } else if (this.title.equals("Kantianism")) {
            this.enumtitle = datanames.KANT.toString();
            this.mdfile = "file:///android_asset/kantianism.md";
        } else {
            this.enumtitle = datanames.VIRTUE.toString();
            this.mdfile = "file:///android_asset/virtueethics.md";
        }
    ...
    private void removeItem() {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(this.enumtitle);
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(this.enumtitle)) {
            bookMark();
        } else {
            bookUnmark();
        }
