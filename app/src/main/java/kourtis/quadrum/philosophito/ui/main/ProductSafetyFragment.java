...
import kourtis.quadrum.philosophito.databinding.FragmentProductSafetyBinding;
...
public class ProductSafetyFragment extends Fragment {
    ...
    private void saveItem() {
        ...
        favoriteItem.setId(datanames.PROD.toString());
        favoriteItem.setTextcontent("");
        favoriteItem.setTitle("Product Safety");
        favoriteItem.setMdFile("file:///android_asset/safety.md");
    ...
    private void removeItem() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(requireContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(datanames.PROD.toString());
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(datanames.PROD.toString())) {
            bookMark();
        } else {
            bookUnmark();
        }
