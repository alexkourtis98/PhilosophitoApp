...
public class CorporateGovernanceFragment extends Fragment {
    ...
    private void saveItem() {
        ...
        favoriteItem.setId(datanames.CORP.toString());
        favoriteItem.setTextcontent("");
        favoriteItem.setTitle("Corporate Governance");
        favoriteItem.setMdFile("file:///android_asset/governance.md");
    ...
    private void removeItem() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(requireContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(datanames.CORP.toString());
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(datanames.CORP.toString())) {
            bookMark();
        } else {
            bookUnmark();
        }
    ...
    public View onCreateView(
        ...
        markdownView.loadMarkdownFile("file:///android_asset/", "file:///android_asset/governance.md", "file:///android_asset/style.css");
