...
public class DiscriminationFragment extends Fragment {
    ...
    private void saveItem() {
        ...
        favoriteItem.setId(datanames.DISC.toString());
        favoriteItem.setTextcontent("");
        favoriteItem.setTitle("Discrimination");
        favoriteItem.setMdFile("file:///android_asset/discrimination.md");
    ...
    private void removeItem() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(requireContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(datanames.DISC.toString());
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(datanames.DISC.toString())) {
            bookMark();
        } else {
            bookUnmark();
        }
