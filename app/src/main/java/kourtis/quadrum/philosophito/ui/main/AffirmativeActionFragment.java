...
public class AffirmativeActionFragment extends Fragment {
    ...
    private void saveItem() {
        ...
        favoriteItem.setId(datanames.AFF.toString());
        favoriteItem.setTextcontent("");
        favoriteItem.setTitle("Affirmative Action");
        favoriteItem.setMdFile("file:///android_asset/affirmativeaction.md");
    ...
    private void removeItem() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(requireContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(datanames.AFF.toString());
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(datanames.AFF.toString())) {
            bookMark();
        } else {
            bookUnmark();
        }
    ...
    public View onCreateView(
        ...
        markdownView.loadMarkdownFile("file:///android_asset/", "file:///android_asset/affirmativeaction.md", "file:///android_asset/style.css");
