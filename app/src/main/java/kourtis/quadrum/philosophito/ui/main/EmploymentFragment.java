...
import kourtis.quadrum.philosophito.databinding.FragmentEmploymentBinding;
...
public class EmploymentFragment extends Fragment {
    ...
    private void saveItem() {
        ...
        favoriteItem.setId(datanames.EMP.toString());
        favoriteItem.setTextcontent("");
        favoriteItem.setTitle("Employment");
        favoriteItem.setMdFile("file:///android_asset/employment.md");
    ...
    private void removeItem() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(requireContext());
        SharedPreferences.Editor prefsEditor = prefs.edit();
        prefsEditor.remove(datanames.EMP.toString());
        prefsEditor.apply();
    }
    ...
    private void checkIfBooked() {
        ...
        if (mPrefs.getAll().containsKey(datanames.EMP.toString())) {
            bookMark();
        } else {
            bookUnmark();
        }
    ...
    public View onCreateView(
        ...
        markdownView.loadMarkdownFile("file:///android_asset/", "file:///android_asset/employment.md", "file:///android_asset/style.css");
